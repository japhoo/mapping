...
// Map Listing items START
    ...
    var placements = [

        {
            ...
            link: '#',
            bgImg: '../../html/directro/images/listing/grid/01.jpg',
            body: '<p><i class="fas fa-map-marker-alt pe-2"></i> Virginia drive temple hills</p>' +
...

		{
            ...
            link: '#',
            bgImg: '../../html/directro/images/listing/grid/02.jpg',
            body: '<p><i class="fas fa-map-marker-alt pe-2"></i> Border st. nicholasville, ky</p>' +
                '<div class="listing-rating-call mt-3"><a class="listing-rating" href="#"><span>5.4</span> 12 Rating</a><a class="listing-call" href="#"><i class="fas fa-phone-volume"></i> +440 125 658</a>',
		...
		},
		{
            ...
            link: '#',
            bgImg: '../../html/directro/images/listing/grid/03.jpg',
            body: '<p><i class="fas fa-map-marker-alt pe-2"></i> Newport st. mebane, nc</p>' +
                '<div class="listing-rating-call mt-3"><a class="listing-rating" href="#"><span>5.4</span> 12 Rating</a><a class="listing-call" href="#"><i class="fas fa-phone-volume"></i> +440 125 658</a>',
		...
		},
		{
            ...
            link: '#',
            bgImg: '../../html/directro/images/listing/grid/04.jpg',
            body: '<p><i class="fas fa-map-marker-alt pe-2"></i> Vermont dr. hephzibah</p>' +
                '<div class="listing-rating-call mt-3"><a class="listing-rating" href="#"><span>5.4</span> 12 Rating</a><a class="listing-call" href="#"><i class="fas fa-phone-volume"></i> +440 125 658</a>',
		...
		},
        {
            ...
            link: '#',
            permalink: 'hitest',
            bgImg: '../../html/directro/images/listing/grid/05.jpg',
            body: '<p><i class="fas fa-map-marker-alt pe-2"></i> West Indian St. Missoula</p>' +
                '<div class="listing-rating-call mt-3"><a class="listing-rating" href="#"><span>5.4</span> 12 Rating</a><a class="listing-call" href="#"><i class="fas fa-phone-volume"></i> +440 125 658</a>',
        ...
        },
        {
            ...
            link: '#',
            bgImg: '../../html/directro/images/listing/grid/06.jpg',
            body: '<p><i class="fas fa-map-marker-alt pe-2"></i> Hamilton rd. willoughby, oh</p>' +
                '<div class="listing-rating-call mt-3"><a class="listing-rating" href="#"><span>5.4</span> 12 Rating</a><a class="listing-call" href="#"><i class="fas fa-phone-volume"></i> +440 125 658</a>',
